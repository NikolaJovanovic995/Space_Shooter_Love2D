...
MathUtils.clamp = function(num, lower, upper)
    return math.max(lower, math.min(upper, num))
end

MathUtils.calculateDistance = function (x1, y1, x2, y2)
    return math.sqrt((x2 - x1) ^ 2 + (y2 - y1) ^ 2)
end

MathUtils.isColliding = function (x1, y1, offsetX1, offsetY1, x2, y2, offsetX2, offsetY2)
